...
(use-package centaur-tabs
  ...
  (define-key centaur-tabs-mode-map (kbd "C-c C-o") nil)
  (define-key centaur-tabs-mode-map (kbd "C-c C-d") nil)
  (define-key centaur-tabs-mode-map (kbd "C-c C-k") nil)
...
#+begin_src emacs-lisp
;; 不能设置 :demand, 在 Emacs 和 doom-modeline 均启动完成后再启动 dashboard, 否则 modeline 可能溢出。
