...
#+LASTMOD: 2023-01-16T21:01:29+0800
...
# install tree-sitter grammer module: https://github.com/casouri/tree-sitter-module
...
安装最新的 universal ctags 工具：
#+begin_src shell :tangle no
brew install --HEAD universal-ctags/universal-ctags/universal-ctags
which ctags readtags
#+end_src

citre 是基于 TAGS 文件的代码浏览工具：
#+begin_src emacs-lisp
(use-package citre
  :defer t
...
citre 默认支持 imenu 和 xref 集成， 所以可以使用 ~M-.~ 和 ~M-,~ 跳转, 也可以使用 consult-imenu 展示当前 buffer 的
条目。 在 citre-jump 的弹出时 buffer 中可以使用正则语法对候选者进行过滤, 例如:
