...
#+LASTMOD: 2024-03-14T22:03:57+0800
...
patch:
  ...
  switcher/abbreviate_options: false # 折叠时是否缩写选项
  key_binder/bindings:
...
patch:
  ...
  translator/always_show_comments: false #是否强制显示全拼双拼的拼音
  # 模糊拼音
  "speller/algebra":
    ### 模糊音
    # 声母
...
Eglot 不指示 ElDoc 在 echo-area 显示结构化成员(field) 或函数签名信息, 但是 M-x eldoc-doc-buffer 命令
显示的 eldoc buffer 中会显示这些信息.
